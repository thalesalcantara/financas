...
BUILD_VERSION = "2026-08-27.2050-v20"
...
def post_worker_init(worker):
    try:
        ...
        log.info("Admin V20 carregado. Build %s", BUILD_VERSION)
    except Exception:
